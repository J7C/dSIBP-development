(* ::Package:: *)
(* 本检查在新 kernel 中读取 014 单文件交付，逐项核对版本、公开 usage、sp 属性和用户手册附录 A 的关键缺省选项。 *)
...
resultPath = FileNameJoin[{resultsDir, "package-contract.wl"}];
...
(*手册汇总表与消息接口*)
publicFunctions = {
  DSInit, DSInfo, DSSeeds, DSLinear, DSKiraExport, DSKiraImport,
...
appendCheck["version", $dSIBPVersion, "014"];
