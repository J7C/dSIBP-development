...
\:5219\:53ef\:53cd\:5411\:8f6c\:6362\:3002"|>, "ispData" -> {}, "nV" -> 2,
   ...
   "effectiveRuleCount" -> 1|>, "externalInvariantRules" -> {},
 "externalLegInvariantRules" -> {sp[p12, p12] -> sE1^2},
 "externalInvariantCoordinateData" -> {},
 "externalLegInvariantCoordinateData" ->
  {<|"occurrenceIndex" -> 1, "momentum" -> p12, "squaredExpression" ->
    ...
    "externalLegIndex" -> 1, "userVariable" -> sE1,
    "defaultSquaredExpression" -> sE1^2, "scalarProduct" -> sp[p12, p12],
    "publicExpression" -> sE1^2, "coordinateType" -> "externalLegSquareRoot",
    "userJacobian" -> 1|>}, "kinematicCoordinateAudit" ->
  <|"status" -> "complete", "source" -> "default",
   "baseCoordinateData" -> {<|"occurrenceIndex" -> 1, "momentum" -> p12,
      "squaredExpression" -> sp[p12, p12], "magnitudeExpression" ->
...
\:53ef\:53cd\:5411\:8f6c\:6362\:3002"|>, "independentVariables" ->
  {sE1, E1, E2}, "defaultDerivativeCoordinates" -> "ssij for the complete \
loop-external Gram basis; sE1,sE2,... for the first-occurrence independent \
basis of actually appearing no-loop momentum magnitudes",
