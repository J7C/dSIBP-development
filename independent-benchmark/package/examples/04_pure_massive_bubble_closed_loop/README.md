...
本例固定 `--` branch、even parity 和等能量约束。package 顶点能量为 `P_pkg=P0=+I k0`，reference basis 的能量为 `P1=P2=P_ref=-P0=-I k0`。本例演示从 016 package 初始化到 Kira 输入、外部 reduction、结果取回、19 维微分方程与 Eq. (51)/(64) 标度检查的完整流程。顶点交换 symmetry 只在本例等能量约束下启用；独立 `P1/P2` family 不得复用。
