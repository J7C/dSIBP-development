...
case = <|
   ...
   "vertices" -> {
     <|"id" -> v1, "vertexType" -> "+", "externalLegEnergy" -> kE|>,
     <|"id" -> v2, "vertexType" -> "+", "externalLegEnergy" -> kE|>
     },
   "lines" -> {
...
summary = <|
   ...
   "externalLegEnergyByVertex" -> Lookup[topology, "sectorExternalLegEnergyByVertex", <||>],
...
If[! And[
    ...
    summary["externalLegEnergyByVertex"] === <|v1 -> kE, v2 -> kE|>,
