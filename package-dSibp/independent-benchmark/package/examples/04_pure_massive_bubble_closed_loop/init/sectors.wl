{<|"caseName" -> "017PureMassiveBubbleClosedLoopMinusMinus", "sectorShrunkLines" -> {}, "sectorKey" -> "top",
  ...
  "ispSlots" -> {}, "sectorPattern" -> {<|"powerKind" -> "cycle", "state" -> "full"|>,
    <|"powerKind" -> "cycle", "state" -> "full"|>}, "sectorPrefactorData" ->
   <|"lineIndices" -> {}, "parameterKeys" -> {}, "parameterList" -> {}, "powerList" -> {}, "powerParts" -> {},
    "constantPrefactor" -> 1, "normalizationConvention" -> "zeroPointOnly"|>, "builtInRelationData" -> {},
 ...
 <|"caseName" -> "017PureMassiveBubbleClosedLoopMinusMinus_sector_e1", "sectorShrunkLines" -> {1}, "sectorKey" -> "e1",
  ...
  "ispSlots" -> {}, "sectorPattern" -> {<|"powerKind" -> "cycle", "state" -> "shrunk"|>,
    <|"powerKind" -> "cycle", "state" -> "full"|>}, "sectorPrefactorData" ->
   <|"lineIndices" -> {}, "parameterKeys" -> {}, "parameterList" -> {}, "powerList" -> {}, "powerParts" -> {},
    "constantPrefactor" -> 1, "normalizationConvention" -> "zeroPointOnly"|>, "builtInRelationData" -> {},
  "parityData" -> <|"status" -> "disabled", "reason" -> "noParityConstraints", "parityUsableQ" -> True,
    "constraints" -> {}|>, "representation" -> "J[aList,linePacks,ispList]"|>,
 <|"caseName" -> "017PureMassiveBubbleClosedLoopMinusMinus_sector_e2", "sectorShrunkLines" -> {2}, "sectorKey" -> "e2",
  "aSlotMode" -> "compactActiveSlots", "sectorVertexRepresentativeMap" -> <|v1 -> v1, v2 -> v1|>,
  "vertexIdToOriginalASlot" -> <|v1 -> 1, v2 -> 2|>, "vertexIdToCompactASlot" -> <|v1 -> 1, v2 -> 1|>,
  "vertexSlots" -> {<|"slot" -> 1, "vertexId" -> v1, "representativeVertexId" -> v1, "aSymbol" -> a[v1],
     "activeQ" -> True, "fixedValue" -> None, "compactASlot" -> 1|>, <|"slot" -> 2, "vertexId" -> v2,
  ...
  "sectorPrefactorData" -> <|"lineIndices" -> {}, "parameterKeys" -> {}, "parameterList" -> {}, "powerList" -> {},
    "powerParts" -> {}, "constantPrefactor" -> 1, "normalizationConvention" -> "zeroPointOnly"|>,
