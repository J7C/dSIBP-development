...
\begin{verbatim}
python -m pip install path/to/package-FlintNDE/versions/FlintNDE-0.3.0
\end{verbatim}
...
The source tree also provides a standard Wolfram Language package.  Add the 0.3.0 version
