...
closed instead of generating a regulator value outside the user-approved range.  To bound the
complete run, including checks, the user must also provide an explicit disjoint
\texttt{validation\_points} sequence.
...
\texttt{fit\_max\_rounds=3} & Maximum number of fit/validation rounds before closed failure. \\
