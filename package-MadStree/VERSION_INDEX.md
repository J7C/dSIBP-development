...
- 版本：`v0.5`
- 目录：`versions/MadStree-v0.5/`
- 状态：当前工作版本
- 独立验证：T1--T6 已于 2026-07-30 从 v0.5 源码 fresh 通过，计数依次为 `24/24`、`12/12`、`18/18`、`15/15`、`17/17`、`16/16`。

## 保留版本

- `v0.3`：冻结源码、手册、examples 与 T1--T6 报告，不再回写。
- `v0.4`：冻结源码、手册、examples 与 T1--T5 报告，不再回写。
- `v0.5`：当前工作版本，更新说明见 `versions/MadStree-v0.5/UPDATE_NOTES.md`。
