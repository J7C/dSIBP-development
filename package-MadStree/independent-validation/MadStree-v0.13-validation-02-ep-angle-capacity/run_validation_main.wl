...
用途：独立验证 MadStree v0.13 正规化角域、自动候选容量和候选池耗尽合同。
...
reportFile = FileNameJoin[{validationRoot, "000_MadStree-v0.13-validation-02-ep-angle-capacity-report.md"}];
...
|>;
evidence = <|
  "schema" -> "madstree_v0.13_ep_angle_capacity_validation_v1",
  "status" -> status,
...
report = StringRiffle[{
  ...
  If[status === "passed",
    ...
    "本专项失败；失败键见 `results/summary.wl`，不得据此认证当前 v0.13。"
  ]
}, "\n"];
...
Print["MadStree v0.13 validation-02: ", passedCount, "/", Length[checks], " ", status];
