<|"schema" -> "madstree_independent_validation_v1", "version" -> "v0.5",
 ...
 "transportOrder" -> Missing["NotApplicable"], "matrixSeconds" -> 0.0002392, "reductionSeconds" -> 0.125237,
 "transformSeconds" -> 1.2629044, "elapsedSeconds" -> 1.5165797`7.632410231987484|>
