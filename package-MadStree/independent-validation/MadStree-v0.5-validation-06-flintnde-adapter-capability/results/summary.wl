<|"schema" -> "madstree_independent_validation_v1", "version" -> "v0.5",
 ...
 "sourceDigests" -> <|"Kernel\\Numerics\\FlintNDE.wl" ->
    "a122f630a2c07abb6fbaeb07867b8c8436ad59b617cd473e9bc1d45571ede7a8", "Backend\\flintnde_transport.py" ->
 ...
 "ordinarySavedPoints" -> {<|"schema" -> "flintnde_saved_point_v1", "sequence" -> 1, "coordinate" -> "0",
    ...
    "sourceFile" -> "F:\\Agent-projects-nut\\dSibp_package\\package-MadStree\\independent-validation\\MadStree-v0.5-val\
idation-06-flintnde-adapter-capability\\results\\flintnde_save_points\\run-f73d81dd-d26c-4052-96e3-a5ae22079ee0\\ordina\
...
package-MadStree\\independent-validation\\MadStree-v0.5-validation-06-flintnde-adapter-capability\\results\\flintnde_sa\
ve_points\\run-f73d81dd-d26c-4052-96e3-a5ae22079ee0\\ordinary\\flintnde_save_002.json"|>,
...
package-MadStree\\independent-validation\\MadStree-v0.5-validation-06-flintnde-adapter-capability\\results\\flintnde_sa\
ve_points\\run-f73d81dd-d26c-4052-96e3-a5ae22079ee0\\ordinary\\flintnde_save_003.json"|>},
 ...
 "singularSavedPoints" -> {<|"schema" -> "flintnde_saved_point_v1", "sequence" -> 1, "coordinate" -> "0",
    ...
    "result" -> <|"schema" -> "flintnde_frobenius_boundary_v1", "terms" -> {<|"a" -> "2", "b" -> 0, "C" -> {"1"}|>},
      "localBasisMethod" -> "regular_singular_power_log"|>, "file" -> "flintnde_save_001.json", "stage" -> "singular",
    "sourceFile" -> "F:\\Agent-projects-nut\\dSibp_package\\package-MadStree\\independent-validation\\MadStree-v0.5-val\
idation-06-flintnde-adapter-capability\\results\\flintnde_save_points\\run-8ae94917-d8c0-4094-9d1a-b7218c453e4c\\singul\
ar\\flintnde_save_001.json"|>, <|"schema" -> "flintnde_saved_point_v1", "sequence" -> 1,
    "coordinate" -> "1.000000000000000000000000000000000000000", "workingCoordinate" ->
     "1.000000000000000000000000000000000000000", "classification" -> "ordinary", "singularityIdentifier" -> Null,
    "role" -> "target", "resultType" -> "ordinary_vector",
...
package-MadStree\\independent-validation\\MadStree-v0.5-validation-06-flintnde-adapter-capability\\results\\flintnde_sa\
ve_points\\run-8ae94917-d8c0-4094-9d1a-b7218c453e4c\\ordinary\\flintnde_save_001.json"|>},
...
\"F:\\Agent-projects-nut\\dSibp_package\\package-MadStree\\versions\\MadStree-v0.5\\Backend\\flintnde_transport.py\", \
...
start and ordinary target; got non_fuchsian_input_basis, ordinary\n"|>, "boundarySeriesOrder" -> 24,
 ...
 "targetRelativeError" -> "1e-22", "boundarySeconds" -> 0.0192734, "ordinarySeconds" -> 0.7329031,
 "singularSeconds" -> 1.0225005, "failClosedSeconds" -> 0.1720326, "elapsedSeconds" -> 3.1136598`7.944816153091624,
 "ordinarySaveSummary" -> "F:\\Agent-projects-nut\\dSibp_package\\package-MadStree\\independent-validation\\MadStree-v0\
.5-validation-06-flintnde-adapter-capability\\results\\flintnde_save_points\\run-f73d81dd-d26c-4052-96e3-a5ae22079ee0\\\
madstree_flintnde_save_points.json", "singularSaveSummary" -> "F:\\Agent-projects-nut\\dSibp_package\\package-MadStree\
\\independent-validation\\MadStree-v0.5-validation-06-flintnde-adapter-capability\\results\\flintnde_save_points\\run-8\
ae94917-d8c0-4094-9d1a-b7218c453e4c\\madstree_flintnde_save_points.json",
 "runtimeDirectory" -> "F:\\Agent-projects-nut\\dSibp_package\\package-MadStree\\independent-validation\\MadStree-v0.5-\
