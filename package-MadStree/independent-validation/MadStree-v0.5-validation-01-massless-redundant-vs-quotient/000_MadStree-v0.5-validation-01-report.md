# MadStree v0.5 independent validation report: T1 mixed three-vertex massless four-state versus quotient
...
- quotient/redundant production-boundary generation wall time in seconds: `{0.5644185, 0.7944297}`
- quotient/redundant full physical transport wall time in seconds: `{8.4403277, 19.402473}`
- total wall time in seconds: `31.142`
