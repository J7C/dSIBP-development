...
only after failed validation.  Pool exhaustion fails closed and never creates an out-of-range
value.  All three options default to \texttt{Automatic}, preserving the original default call and
