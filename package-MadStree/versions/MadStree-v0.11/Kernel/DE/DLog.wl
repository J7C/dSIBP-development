...
msContactDLogBlock[
  ...
  reductionRecords = Table[
    ...
    (* -I T^-1 OmegaTilde0 T is already in the component kernel. For pure massive events only the vertex phase sign remains; events containing massless lines additionally need the (-1)^N0 of the exponential quotient relative to the h/Wronskian atoms. *)
    localBlock = Simplify[
      contactPhase
