...
MSFlintNDEConfiguration::usage = "MSFlintNDEConfiguration[] 返回项目根目录、FlintNDE 相对路径及可用性。";
MSSetFlintNDERelativePath::usage = "MSSetFlintNDERelativePath[path] 修改唯一的项目根目录相对 FlintNDE package 路径。";
