...
msExecuteFlintNDEAdapter[inputData_Association, pythonExecutable_, runtimeDirectory_String] := Module[
  {transportDirectory, cacheDirectory, identifier, inputFile, outputFile, adapterFile,
  ...
  cacheDirectory = FileNameJoin[{
    runtimeDirectory, "results_temp", "python_cache", "MadStree-v" <> $MadStreeVersion
  }];
  ...
  process = <|
    ...
    "pythonCacheDirectory" -> cacheDirectory,
    "inputFile" -> inputFile,
