...
msContactDLogBlock[
  ...
  {targetSector, endpointComponents, matrices, r1Shifts, contributions, reductionRecords,
    targetShift, reduction, contactPhase, localBlock,
  ...
  reductionRecords = Table[
    ...
    (* -I T^-1 OmegaTilde0 T 已在 component kernel 中；纯 massive event 只保留 SK 轮廓权重，含 massless 线时还需指数 quotient 相对 h/Wronskian 原子的 (-1)^N0。 *)
    localBlock = Simplify[
      contactPhase
