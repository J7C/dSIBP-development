...
\title{MadStree v0.13: tree formula}
...
\begin{abstract}
本手册对应 \texttt{package-MadStree} v0.13；time-only sector 继续由 root propagator 顺序的定长字符串标识。
...
分开保存，但都由同一个 \texttt{vertexType} 唯一派生。
