...
\begin{abstract}
This handbook corresponds to \texttt{package-MadStree} v0.13; time-only sectors continue to be identified by fixed-length strings in the order of the root propagators.
...
\section{v0.13 topology input convention}
...
point is a transport node. \texttt{TransportOrder} sets the production primary chain; nodes,
