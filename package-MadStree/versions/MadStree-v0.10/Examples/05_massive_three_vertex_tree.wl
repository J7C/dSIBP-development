...
targetPath = MSGeneratePath[
  context,
  {targetRules},
  BoundaryScale -> 4,
  WorkingPrecision -> 32
];
targetValue = MSEvaluatePlannedPath[
  context,
  targetPath,
  WorkingPrecision -> 32,
  TransportOrder -> 72,
...
If[Head[targetValue] === Failure,
  Print["Example failed at MSEvaluatePlannedPath: ", targetValue];
  Exit[1]
];
...
(* ::Chapter:: *)
(* Multipoint planning, execution and export *)
...
exampleGateFailures = Select[
  {targetPath, targetValue, batchPath, batchEvaluation, batchExport},
  Head[#] === Failure &
];
