...
multivariable polyline on the MadStree side and pulls each affine segment back to a
one-variable matrix DE. \texttt{MSEvaluatePlannedPath} executes these stored plans directly:
