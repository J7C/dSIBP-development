...
当前版本：`v0.5`。本目录由冻结 v0.4 建立；接口变化见 `UPDATE_NOTES.md`。
...
```wl
packageRoot = ".../package-MadStree/versions/MadStree-v0.5";
...
FlintNDE 源码随 v0.5 放在版本目录内，缺省位置只在一个相对路径变量中定义：
...
三个 examples 已从 v0.4 迁入 v0.5，并已从 v0.5 源码 fresh 运行且退出 `0`。
...
v0.5 全部 11 个开发 tests、三个 examples 与跨包 DE 检验均已串行 fresh 通过。T1--T6 独立验证计数依次为 `24/24`、`12/12`、`18/18`、`15/15`、`17/17`、`16/16`；报告和机器 summary 位于 `../../independent-validation/MadStree-v0.5-validation-*/`。
