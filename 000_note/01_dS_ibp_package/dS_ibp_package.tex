...
\end{verbatim}
它们分别展示 mixed massive/massless 工作流、一般 \texttt{P,Q,T,W} 函数系统、两圈 ISP、pure massive bubble 的外部 Kira 闭环、两顶点 tree pure-time/dlog 路线，以及 016 的 \texttt{ssij/sEe} 初始化与总导数。examples 不含独立 expected；Kira example 只写输入并取回已有结果，不启动 reduction。
