...
makeSectorMetadataBase017[topo_Association] := Module[
...
dsTreeDLogBlock017[data_Association] := Module[{vertexData, dimensions, omega, letters, letterMatrices, masters},
...
dsTreeDLogBlock017[data_Association, seedData_] := Join[
   dsTreeDLogBlock017[data],
