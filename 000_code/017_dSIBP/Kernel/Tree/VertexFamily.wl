...
(* ::Chapter:: *)
(*017 tree vertex-family Private 公式内核*)
...
(* 017 的公开 tree overload 统一在 PublicBoundary017.wl 定义。这里仅保留 Private
...
dsTreeMultiSectorDLog[context_Association, seedData_: Automatic] := Module[
   ...
   blocks = dsTreeDLogBlock017 /@ families;
...
(* DSTreeDLogDE 的公开定义由 PublicBoundary017.wl 负责把本模块结果映射回统一 J。 *)
