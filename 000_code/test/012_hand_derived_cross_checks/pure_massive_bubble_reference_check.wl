(* ::Package:: *)
(* pure_massive_bubble_reference：读取独立 h/H expected，并作为 012 程序包交叉验证 test。 *)
...
handDerivedDir = FileNameJoin[{codeDir, "test", "012_hand-derived", "pure_massive_bubble_reference"}];
