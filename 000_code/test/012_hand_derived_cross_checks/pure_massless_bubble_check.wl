(* ::Package:: *)
(* pure_massless_bubble：64 条 contact 可达 sector 独立对照。 *)
...
handDerivedDir = FileNameJoin[{codeDir, "test", "012_hand-derived", "pure_massless_bubble"}];
...
If[Length[expectedRelations] =!= 64 || ! SameQ[actualCounts, expectedCounts],
