(* ::Package:: *)
(* parallel_massless_bundle_guard：读取独立 expected，并作为 012 程序包交叉验证 test。 *)
...
handDerivedDir = FileNameJoin[{codeDir, "test", "012_hand-derived", "parallel_massless_bundle_guard"}];
