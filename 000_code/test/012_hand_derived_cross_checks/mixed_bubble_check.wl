(* ::Package:: *)
(* mixed_bubble：132 条 contact 可达 sector 独立对照。 *)
...
handDerivedDir = FileNameJoin[{codeDir, "test", "012_hand-derived", "mixed_bubble"}];
...
If[Length[expectedRelations] =!= 132 || ! SameQ[actualCounts, expectedCounts],
