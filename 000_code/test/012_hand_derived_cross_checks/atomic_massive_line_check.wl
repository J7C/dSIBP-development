...
versionUnderTest = Last[Select[$ScriptCommandLine, MemberQ[{"010", "011", "012"}, #] &], Environment["DSIBP_VERSION"]];
If[!MemberQ[{"010", "011", "012"}, versionUnderTest], versionUnderTest = "012"];
