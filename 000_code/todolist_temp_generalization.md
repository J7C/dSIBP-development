...
- [x] raw case 输入 preflight：`caseInputRequirementReport` 检查 `vertexData/lineData/loopMomenta` 必需字段，`makeTopologyData`、workflow/readiness 对缺字段 case 早停并返回 `missingRequiredCaseKeys`。
