...
- [x] 测试分层：
  ...
  - canonical seed 覆盖门禁（已加入 pure massless bubble、mixed bubble、mixed triangle、mixed sunrise 的 all-sector qIBP/tIBP 分类、top-sector 生成元标签和 EOM canonical 扫描；只看小样本结构，不展开大解析系统）；
