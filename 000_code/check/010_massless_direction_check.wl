(* ::Package:: *)
(* 010 massless 有方向单 n 与 theta-boundary 的极小回归。 *)

(* ::Chapter:: *)
(*初始化*)

Get[FileNameJoin[{DirectoryName[$InputFileName], "..", "010_dS_ibp_general.wl"}]];
...
Print["010 massless checks: ", Count[Values[checks], True], "/", Length[checks]];
