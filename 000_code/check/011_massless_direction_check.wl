(* ::Package:: *)
(* 011 massless 有方向单 n 与 theta-boundary 的极小回归。 *)

(* ::Chapter:: *)
(*初始化*)

Get[FileNameJoin[{DirectoryName[$InputFileName], "..", "011_dS_ibp_general.wl"}]];
...
Print["011 massless checks: ", Count[Values[checks], True], "/", Length[checks]];
