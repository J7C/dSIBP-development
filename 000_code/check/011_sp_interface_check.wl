(* ::Package:: *)
(* 011 专用轻量检查：用户口统一 sp[p,r]，内部仍可用 qq/qk/kk 编号坐标。 *)
...
Get["000_code/011_dS_ibp_general.wl"];
...
If[! TrueQ[spCheckResults["spWorkflowSampledKiraReady"]], Print["sampled workflow diagnostic: ", KeyTake[spWorkflowData, {"status", "stage", "reason", "missingLineParameters", "numericRuleRequirementReport", "linearSystem", "kiraExport"}]]];
If[! TrueQ[spCheckResults["spWorkflowSampledDefaultsUseNumericRules"]], Print["default workflow diagnostic: ", KeyTake[spWorkflowDefaultRulesData, {"status", "stage", "reason", "missingLineParameters", "numericRuleRequirementReport", "linearSystem", "kiraExport"}]]];
