(* ::Package:: *)
(* 本文件生成 pure massless bubble 的最小 numeric Kira workspace，并检查 006 的基础文件导出门禁。
   它只构造 12 条小样本 canonical seed，不运行 Kira，也不依赖任何本机 Kira/Fermat 路径。 *)
...
smokeCheckResults = <|
   ...
   "smallSeedAndLinearSystem" -> TrueQ[
     Lookup[smokeSeedBatch, "equationCount", 0] === 12 &&
      Lookup[smokeLinearSystem, "equationCount", 0] === 12 &&
      Lookup[smokeLinearSystem, "integralCount", 0] === 9
     ],
