(* ::Package:: *)
(* 本检查在全新 kernel 中只加载独立交付的 package_014.wl，确认冻结单文件不依赖模块源码目录，
...
packageFile = FileNameJoin[{projectRoot, "independent-benchmark", "package", "package_014.wl"}];
...
Print["014 single-file package checks: ", passed, "/", total];
