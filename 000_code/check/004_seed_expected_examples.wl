...
expectedTimeSeedMasslessBubbleTau1[] := Module[
   {aList, int0, intA1Down, intLine1Flip, intLine2Flip},
   aList = {Global`a[1], Global`a[2]};
   int0 = Global`J[aList, {{Global`b[1], Global`n[1]}, {Global`b[2], Global`n[2]}}, {}];
   intA1Down = Global`J[{Global`a[1] - 1, Global`a[2]}, {{Global`b[1], Global`n[1]}, {Global`b[2], Global`n[2]}}, {}];
   intLine1Flip = Global`J[aList, {{Global`b[1] - 1, 1 - Global`n[1]}, {Global`b[2], Global`n[2]}}, {}];
   intLine2Flip = Global`J[aList, {{Global`b[1], Global`n[1]}, {Global`b[2] - 1, 1 - Global`n[2]}}, {}];
   Expand[-Global`a[1] intA1Down - I Global`p1 int0 + I intLine1Flip + I intLine2Flip]
   ];
...
compareExpectedMasslessBubbleAllSectorHandSeeds[] := Module[
   ...
   <|
    "name" -> "masslessBubble_allSectorHandSeeds_qAndT",
    "pass" -> TrueQ[
      qCheck["pass"] &&
       gotQ === expectedQ &&
       gotT === expectedT &&
    ...
    "coverage" -> <|"top" -> {"qIBP" -> qCheck["name"], "tIBP" -> "masslessBubble_tau1"}|>,
    "gotT" -> gotT,
    "expectedT" -> expectedT,
...
expectedTimeSeedMixedSunriseTau1Core[] := Module[
   {aList, ispList, int0, intA1Down, intLine2Flip, intLine3Flip, intN11, intBoundary, pref},
   aList = {Global`a[1], Global`a[2]};
   ispList = {Global`ispN[1], Global`ispN[2]};
   int0 = Global`J[
     aList,
     {{Global`b[1], Global`n[1, 1], Global`n[1, 2]}, {Global`b[2], Global`n[2]}, {Global`b[3], Global`n[3]}},
     ispList
     ];
   intA1Down = Global`J[
     {Global`a[1] - 1, Global`a[2]},
     {{Global`b[1], Global`n[1, 1], Global`n[1, 2]}, {Global`b[2], Global`n[2]}, {Global`b[3], Global`n[3]}},
     ispList
     ];
   intLine2Flip = Global`J[
     aList,
     {{Global`b[1], Global`n[1, 1], Global`n[1, 2]}, {Global`b[2] - 1, 1 - Global`n[2]}, {Global`b[3], Global`n[3]}},
     ispList
     ];
   intLine3Flip = Global`J[
     aList,
     {{Global`b[1], Global`n[1, 1], Global`n[1, 2]}, {Global`b[2], Global`n[2]}, {Global`b[3] - 1, 1 - Global`n[3]}},
     ispList
     ];
   intN11 = Global`J[
     aList,
     {{Global`b[1] - 1, Global`n[1, 1] + 1, Global`n[1, 2]}, {Global`b[2], Global`n[2]}, {Global`b[3], Global`n[3]}},
     ispList
     ];
   intBoundary = Global`J[
     {Global`a[1] + Global`a[2] - 1},
     {{Global`b[1] + 1}, {Global`b[2], Global`n[2]}, {Global`b[3], Global`n[3]}},
     ispList
     ];
   pref = (4 I/Pi) Exp[Pi Im[Global`nuM]];
   Expand[
    -Global`a[1] intA1Down - I Global`p1 int0 + I intLine2Flip + I intLine3Flip - intN11 +
     pref KroneckerDelta[Global`n[1, 1] + Global`n[1, 2], 1] (-1)^Global`n[1, 1] intBoundary
    ]
   ];
...
expectedMixedBubbleShrinkE1MomentumQ1DotQ1[] := Module[
   {int0, intLine2ShiftWithBS, intLine2Shift, aList},
   aList = {Global`a[1]};
   int0 = Global`J[aList, {{Global`bS[1]}, {Global`b[2], Global`n[2]}}, {}];
   intLine2ShiftWithBS = Global`J[aList, {{Global`bS[1] - 2}, {Global`b[2] + 2, Global`n[2]}}, {}];
   intLine2Shift = Global`J[aList, {{Global`bS[1]}, {Global`b[2] + 2, Global`n[2]}}, {}];
   Expand[
    Global`dim int0 - Global`bS[1] int0 - (Global`b[2]/2) int0 -
     (Global`b[2]/2) intLine2ShiftWithBS + (Global`b[2] Global`kk[1, 1]/2) intLine2Shift
    ]
   ];


expectedMixedBubbleShrinkE1TimeTau1[] := Module[
   {int0, intADown, intMasslessFlip, aList},
   aList = {Global`a[1]};
   int0 = Global`J[aList, {{Global`bS[1]}, {Global`b[2], Global`n[2]}}, {}];
   intADown = Global`J[{Global`a[1] - 1}, {{Global`bS[1]}, {Global`b[2], Global`n[2]}}, {}];
   intMasslessFlip = Global`J[aList, {{Global`bS[1]}, {Global`b[2] - 1, 1 - Global`n[2]}}, {}];
   Expand[-Global`a[1] intADown + I intMasslessFlip - I Global`p1 int0 - I Global`p2 int0]
   ];
...
compareExpectedMixedBubbleAllSectorHandSeeds[] := Module[
   ...
   sectorKeys = Lookup[Global`makeCanonicalSeedBatch[topo]["sectorMetadataList"], "sectorKey"];
   <|
    "name" -> "mixedBubble_allSectorHandSeeds_qAndT",
    "pass" -> TrueQ[
      topQ["pass"] &&
       topT["pass"] &&
       gotQ === expectedQ &&
    ...
    "coverage" -> <|
      "top" -> {"qIBP" -> topQ["name"], "tIBP" -> topT["name"]},
      "e1" -> {"qIBP" -> "mixedBubbleShrinkE1_dq1Dotq1", "tIBP" -> "mixedBubbleShrinkE1_tau1"}
      |>,
    "gotShrinkQ" -> gotQ,
    "expectedShrinkQ" -> expectedQ,
    "gotShrinkT" -> gotT,
    "expectedShrinkT" -> expectedT,
    "sectorKeys" -> sectorKeys
    |>
   ];


expectedMixedSunriseShrinkE1MomentumQ1DotQ1[] := Module[
   {aList, ispList, int0, intLine3ShiftWithBS, intLine2DownLine3Up,
    intLine3UpISP2, intLine3Up},
   aList = {Global`a[1]};
   ispList = {Global`ispN[1], Global`ispN[2]};
   int0 = Global`J[aList, {{Global`bS[1]}, {Global`b[2], Global`n[2]}, {Global`b[3], Global`n[3]}}, ispList];
   intLine3ShiftWithBS = Global`J[aList, {{Global`bS[1] - 2}, {Global`b[2], Global`n[2]}, {Global`b[3] + 2, Global`n[3]}}, ispList];
   intLine2DownLine3Up = Global`J[aList, {{Global`bS[1]}, {Global`b[2] - 2, Global`n[2]}, {Global`b[3] + 2, Global`n[3]}}, ispList];
   intLine3UpISP2 = Global`J[aList, {{Global`bS[1]}, {Global`b[2], Global`n[2]}, {Global`b[3] + 2, Global`n[3]}}, {Global`ispN[1], Global`ispN[2] + 1}];
   intLine3Up = Global`J[aList, {{Global`bS[1]}, {Global`b[2], Global`n[2]}, {Global`b[3] + 2, Global`n[3]}}, ispList];
   Expand[
    Global`dim int0 - Global`bS[1] int0 - (Global`b[3]/2) int0 -
     (Global`b[3]/2) intLine3ShiftWithBS + (Global`b[3]/2) intLine2DownLine3Up +
     Global`b[3] intLine3UpISP2 + (Global`b[3] Global`kk[1, 1]/2) intLine3Up
    ]
   ];


expectedMixedSunriseShrinkE1TimeTau1[] := Module[
   {aList, ispList, int0, intADown, intLine2Flip, intLine3Flip},
   aList = {Global`a[1]};
   ispList = {Global`ispN[1], Global`ispN[2]};
   int0 = Global`J[aList, {{Global`bS[1]}, {Global`b[2], Global`n[2]}, {Global`b[3], Global`n[3]}}, ispList];
   intADown = Global`J[{Global`a[1] - 1}, {{Global`bS[1]}, {Global`b[2], Global`n[2]}, {Global`b[3], Global`n[3]}}, ispList];
   intLine2Flip = Global`J[aList, {{Global`bS[1]}, {Global`b[2] - 1, 1 - Global`n[2]}, {Global`b[3], Global`n[3]}}, ispList];
   intLine3Flip = Global`J[aList, {{Global`bS[1]}, {Global`b[2], Global`n[2]}, {Global`b[3] - 1, 1 - Global`n[3]}}, ispList];
   Expand[-Global`a[1] intADown + I intLine2Flip + I intLine3Flip - I Global`p1 int0 - I Global`p2 int0]
   ];
...
compareExpectedMixedSunriseAllSectorHandSeeds[] := Module[
   ...
   sectorKeys = Lookup[Global`makeCanonicalSeedBatch[topo]["sectorMetadataList"], "sectorKey"];
   <|
    "name" -> "mixedSunrise_allSectorHandSeeds_qAndT",
    "pass" -> TrueQ[
      topQ["pass"] &&
       topT["pass"] &&
       gotQ === expectedQ &&
    ...
    "coverage" -> <|
      "top" -> {"qIBP" -> topQ["name"], "tIBP" -> topT["name"]},
      "e1" -> {"qIBP" -> "mixedSunriseShrinkE1_dq1Dotq1", "tIBP" -> "mixedSunriseShrinkE1_tau1"}
      |>,
    "gotShrinkQ" -> gotQ,
    "expectedShrinkQ" -> expectedQ,
    "gotShrinkT" -> gotT,
...
expectedMomentumSeedMasslessCrossQ1DotQ1[] := Module[
   {aList, int0, intB1DownB2Up, intB2Up},
   aList = {Global`a[1], Global`a[2]};
   int0 = Global`J[aList, {{Global`b[1]}, {Global`b[2]}}, {}];
   intB1DownB2Up = Global`J[aList, {{Global`b[1] - 2}, {Global`b[2] + 2}}, {}];
   intB2Up = Global`J[aList, {{Global`b[1]}, {Global`b[2] + 2}}, {}];
   Expand[
    Global`dim int0 - Global`b[1] int0 - (Global`b[2]/2) intB1DownB2Up -
     (Global`b[2]/2) int0 + (Global`b[2] Global`kk[1, 1]/2) intB2Up
    ]
...
compareExpectedMasslessCrossAllSectorHandSeeds[] := Module[
   ...
   sectorKeys = Lookup[Global`makeCanonicalSeedBatch[topo]["sectorMetadataList"], "sectorKey"];
   <|
    "name" -> "masslessCross_allSectorHandSeeds_qAndT",
    "pass" -> TrueQ[
      summary["packTypes"] === {"masslessCross", "masslessCross"} &&
       timeCheck["pass"] &&
       gotQ === expectedQ &&
    ...
    "coverage" -> <|"top" -> {"qIBP" -> "masslessCross_dq1Dotq1", "tIBP" -> timeCheck["name"]}|>,
    "gotQ" -> gotQ,
    "expectedQ" -> expectedQ,
    "sectorKeys" -> sectorKeys
    |>
...
compareExpectedWithCurrentGenerator[] := Module[
   ...
   <|
    ...
    "masslessBubbleAllSectorHandSeeds" -> compareExpectedMasslessBubbleAllSectorHandSeeds[],
    ...
    "masslessCrossAllSectorHandSeeds" -> compareExpectedMasslessCrossAllSectorHandSeeds[],
