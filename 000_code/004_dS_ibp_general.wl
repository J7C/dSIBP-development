...
integralSectorKey[J[aList_, linePacks_, ispList_], metadataList_List] := Module[
   {lengths = Length /@ linePacks, hit},
   hit = SelectFirst[metadataList, sectorMetadataLinePackLengths[#] === lengths &, Missing["NoMatchingSector"]];
   If[Head[hit] === Missing, Missing["NoMatchingSector"], sectorMetadataKey[hit]]
   ];
