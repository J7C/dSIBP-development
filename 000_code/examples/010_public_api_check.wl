(* ::Package:: *)
(* 010：公开 IBP 算子、内外表示转换与 inert integrand 小型检查。 *)

exampleDir = DirectoryName[$InputFileName];
codeDir = DirectoryName[exampleDir];
Get[FileNameJoin[{codeDir, "010_dS_ibp_general.wl"}]];
...
Print["010 public API checks: ", Count[Lookup[checks, "passQ"], True], "/", Length[checks]];
